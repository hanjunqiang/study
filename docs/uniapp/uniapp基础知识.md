---
title: uniapp基础知识
date: 2021-01-07 10:21:19
permalink: /pages/85cccb/
categories:
  - uniapp
tags:
  - 
...
+ 选择uni-app,填写项目名称，项目创建的目录
  ...
  <!-- ![](./images/create.jpg) -->
  <img style="margin-top:10px" :src="$withBase('/uniapp/创建项目.jpg')" alt="暂无图片">
...
<!-- ![](./images/组件属性.png) -->
<img style="margin-top:10px" :src="$withBase('/uniapp/组件属性.jpg')" alt="暂无图片">
